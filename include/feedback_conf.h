...
#define I_CHANNELS 16                   //!< input channels to be used, can save RAM in error matrix
#define O_CHANNELS 12                   //!< output channels to be used, can save RAM in error matrix
